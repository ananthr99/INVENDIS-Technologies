    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-8 lg:px-0 py-16">
        ...
        <Section title="4. How we store and protect your data">
          <p>
            Contact form submissions are routed directly to our team via email. We do not store
            your personal data in our own databases or CRM systems beyond what is necessary to
            respond to your enquiry. We review and delete correspondence that is older than
            12 months and not part of an ongoing business relationship.
          </p>
        </Section>
        ...
        <Section title="7. International data transfers">
          <p>
            Our website is operated by an Indian company and personal data is processed under
            the Indian Digital Personal Data Protection Act, 2023 (DPDP Act). Data submitted
            via contact forms is handled within our team and not transferred to third-party
            processors for storage.
          </p>
        </Section>
