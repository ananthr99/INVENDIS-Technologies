import{t as e}from"./createLucideIcon-DRT9ThZX.js";var t=e(`calendar`,[[`path`,{d:`M8 2v4`,key:`1cmpym`}],[`path`,{d:`M16 2v4`,key:`4m81vk`}],[`rect`,{width:`18`,height:`18`,x:`3`,y:`4`,rx:`2`,key:`1hopcy`}],[`path`,{d:`M3 10h18`,key:`8toen8`}]]),n=e(`clock`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6l4 2`,key:`mmk7yg`}]]),r=Object.assign({"../content/blog/choosing-industrial-router-remote-sites.md":`---
...
`});function i(e){return e.split(`/`).pop().replace(/\.md$/,``)}function a(e){let t=e.trim().split(/\s+/).length;return Math.max(1,Math.ceil(t/200))}function o(e){let t=e.match(/^---\r?\n([\s\S]*?)\r?\n---\r?\n?([\s\S]*)/);if(!t)return{data:{},content:e.trim()};let n=t[2].trim(),r={},i=null;for(let e of t[1].split(/\r?\n/)){if(!e.trim())continue;let t=e.match(/^-\s+(.+)$/);if(t&&i){Array.isArray(r[i])||(r[i]=[]),r[i].push(t[1].replace(/^["'](.*)["']$/,`$1`));continue}let n=e.match(/^([\w]+):\s*(.*)$/);if(n){i=n[1];let e=n[2].trim();r[i]=e===``?[]:e.replace(/^["'](.*)["']$/,`$1`)}}return{data:r,content:n}}function s(){return Object.entries(r).map(([e,t])=>{let n=i(e),{data:r,content:s}=o(t);return{slug:n,content:s,readTime:a(s),...r}}).sort((e,t)=>new Date(t.date)-new Date(e.date))}function c(e){let t=Object.entries(r).find(([t])=>i(t)===e);if(!t)return null;let[,n]=t,{data:s,content:c}=o(n);return{slug:e,content:c,readTime:a(c),...s}}export{t as i,c as n,n as r,s as t};